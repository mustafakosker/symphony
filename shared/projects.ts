...
export type BriefCopy = {
  version: number;
  digest: string;
  author: "generated" | "human" | "human-edited";
  source: SnapshotRef;
  report: SourceReport;
  createdAt: string;
};
...
export type ProjectReadiness =
  "discovered" | "needs-setup" | "preparing" | "ready" | "failed";
export type OperationStatus = {
  id: string;
  revision: number;
  kind: "scan" | "prepare" | "verify" | "brief" | "submission";
...
export type ProjectRecord = ProjectName & {
  repositoryId: string;
  generation: string;
  sourcePath: string;
  gitDir: string;
...
export type CatalogSnapshot = CatalogView & {
  records: ProjectRecord[];
  ineligible: DiscoveryEntry[];
  scannedAt: string;
};
...
export type SnapshotManifest = {
  version: 1;
  ref: Omit<SnapshotRef, "manifestDigest">;
